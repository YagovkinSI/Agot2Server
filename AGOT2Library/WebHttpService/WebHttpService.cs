                    ...
                    else
                    {
                        ...
                        if (user.resetPswDate == null || (dateTimeNow - user.resetPswDate.Value).TotalMinutes > 15)
                        {
                            try
                            {
                                ...
                                MyLibrary.EMail.Send(user.email, "AGOT: online", $"<a href='http://lantsev1981.pro:6999/WebHttpService/ResetPassword/?code={user.resetPswCode}'>Click the link to reset the password.</a>", null, true);
